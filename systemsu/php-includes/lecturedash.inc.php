...
//include_once 'php-includes/pg.php'; 
...
if ($page == "AddStudents"){
    ...
    if ($page == "StudentAttendance"){
     ...
     require_once 'php-includes/announcement.inc.php'; 
       ...
       if ($page == "Notes"){
     require_once 'php-includes/notes.inc.php'; 
} else {
    if ($page == "BConverter"){
     require_once 'php-includes/bconverter.inc.php'; 
} else {
     if ($page == "OldStudentAllocations"){
     require_once 'php-includes/oldstudentallow.inc.php'; 
}     
}    
}
}
...
?>
       ...
       ?>
            ...
            <small>Hi.. <?php echo $FirstName ?></small>
