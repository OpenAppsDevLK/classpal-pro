...
?>
          ...
          <h1>
            Announcements
            <small>You can add Announcement to the students...</small>
          </h1>
        </section>
            ...
            <div class="box-body">
                <div class="box-body">
                  <form id="form_addstudent" role="form" action="<?php $ADDANNOUS;  ?>" method="post" enctype="multipart/form-data" >
                    <!-- text input -->       
                      <input type="hidden" name="txt_AutoID" value="<?php echo $Annoid;  ?>" class="form-control" placeholder="AUTO" readonly>
