...
?>
          ...
          <h1>
            Edit Subject
            <small>You can update subject details...</small>
          </h1>
        </section>
        ...
        <section class="content">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <input  style="margin-top: 5px;" class="btn  btn-success btn-lg" type="submit" onclick="" value="Update Subject">
                <a style="margin-top: 5px;" href="index.php?page=SubNPay&PageNo=1" class="btn  btn-primary">View All Subjects</a>
                </div>
