...
?>
          <h1>
            Student Absents
            <small>You can mark daily students absents...</small>
          </h1>
        </section>
                ...
                <div class="box-body">
                  ...
                  ?>
                    ...
                    <i class="fa fa-book"></i>
                      ...
                      <select class="form-control" name="jumpmenu" onChange="jumpto(document.form1.jumpmenu.options[document.form1.jumpmenu.options.selectedIndex].value)">
                         ...
                         ?>
                         <option value="index.php?page=AddAbsents&SubjID=<?php echo $Subj_id  ?>&SubjName=<?php echo $Subj_Name;  ?>"> <?php echo $Subj_Name; ?></option>
                  ...
                  ?>
                    ...
                    <i class="fa fa-book"></i>
                      ...
                      <form name="form2" id="form_addsubject" role="form" action="" method="get">
                      <select class="form-control" name="jumpmenu2" onChange="jumpto2(document.form2.jumpmenu2.options[document.form2.jumpmenu2.options.selectedIndex].value)">
                         ...
                         ?>
                         <option value="index.php?page=AddAbsents&SubjID=<?php echo $Subj_id1  ?>&SubjName=<?php echo $Subj_Name2;  ?>&LecturerID=<?php echo $lec_id;  ?>&LecturerName=<?php echo $lec_name;  ?>"> <?php echo $lec_name; ?></option>
                  ...
                  <form id="form_addstudent" role="form" action="<?php  ?>" method="post" enctype="multipart/form-data" >
                    ...
                    <label>Subject ID</label> 
                       <input type="text" value="<?php echo $_GET['SubjID']; ?>" name="txt_ab_SubjectID" class="form-control" readonly>
                    </div>
             
                    <div class="form-group">
                    <label>Subject Name</label> 
                       <input type="text" value="<?php echo $_GET['SubjName']; ?>" name="txt_ab_SubjectName" class="form-control" readonly>
                    </div>
                    
                    <div class="form-group">
                        <label>Lecturer ID</label>
                        <input type="text" value="<?php echo $_GET['LecturerID']; ?>" name="txt-sa_LecturerID" class="form-control" readonly>
                     </div>
 
                    <div class="form-group"> 
                    <label>Lecturer Name</label>  
                         <input type="text" value="<?php echo $_GET['LecturerName']; ?>" name="txt-sa_LecturerName" class="form-control" readonly>
                    </div>
                      ...
                      <label>Student ID</label>
                       <div class="input-group">
                        ...
                        <i class="fa fa-key"></i>
                           ...
                           <input type="number" name="txt_ab_student_id" class="form-control" required >
                       </div>
                    </div>
 ...
 ?>
			...
			<SCRIPT LANGUAGE="JavaScript">
                                    ...
                                    swal({   title: "Are you sure?",   text: "Do you want to delete ?",   type: "warning",   showCancelButton: true,   confirmButtonColor: "#DD6B55",   confirmButtonText: "Yes, delete.",   cancelButtonText: "No, Cancel.",   closeOnConfirm: false,   closeOnCancel: false }, function(isConfirm){   if (isConfirm) {  document.myform.action = "actions/deleteabsents.php?page=StudentAttendance&PageNo=<?php echo $PNo; ?>";  document.myform.submit(); } else {     swal("Cancelled", "There are safe :)", "error");   } });
