...
$stmt1130->bind_result($cp_users_id, $cp_users_firstname, $cp_users_lastname, $cp_userpermission_permission_id, $cp_userpermission_uid, $cp_userpermission_OnOff);
$stmt1130->execute();
...
$sql = "SELECT COUNT(stu_ID) FROM cp_oldstudents";
...
$sql = "SELECT * FROM cp_oldstudents ORDER BY stu_studentID ASC $limit";
...
if($last != 1){
	...
	if ($pagenum > 1) {
        $previous = $pagenum - 1;
		$paginationCtrls .= '<li><a href="index.php?page=RemovedStudents&PageNo=1">&laquo;&laquo;</a></li>'
                                 .'<li><a href="index.php?page=RemovedStudents&PageNo='.$previous.'">&laquo;</a></li>';
                         
		// Render clickable number links that should appear on the left of the target page number
		for($i = $pagenum-2; $i < $pagenum; $i++){
			if($i > 0){
		        $paginationCtrls .= '<li><a href="index.php?page=RemovedStudents&PageNo='.$i.'">'.$i.'</a></li>';
			}
	    }
    }
    ...
    if ($pagenum != $last) {
        $next = $pagenum + 1;
        $paginationCtrls .= '<li><a href="index.php?page=RemovedStudents&PageNo='.$next.'">&raquo;</a></li> '
                         .'<li><a href="index.php?page=RemovedStudents&PageNo='.$last.'">&raquo;&raquo;</a></li>'
                         .'</ul>';
    }
}
...
//        $Message .= "</p>";
 ...
 ?>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Old Students</li>
          </ol>
        ...
        <section class="content">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Old Students</h3>
        ...
        <div class="box-body">
         ...
         <!-- Search Form -->       
                ...
                <form style="margin-bottom: 10px;" role="form" method="get" action="" class="form-inline">
                    <input type="hidden" name="page" value="RemovedStudents">
                    ...
                    <a style="margin-top: 10px;" href="index.php?page=RemovedStudents&PageNo=1" class="btn btn-success btn-flat" >View All</a>
                </form>
 ...
 ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                         ...
                         <td><?php  echo $row['stu_regdate'] ?></td>
                         <td><?php  echo $row['stu_studentname'] ?></td>
                         <td><?php  echo $row['stu_address'] ?></td>
                         <td><?php  echo $row['stu_sex'] ?></td>
                         <td><?php  echo $row['stu_bday'] ?></td>
                         <td><?php echo $row['stu_con_mobile1']; ?></td>
                         <td><?php echo $row['stu_con_mobile1']; ?></td>
                         <td><?php echo $row['stu_con_mobile1']; ?></td>
                         <td><?php  echo $row['stu_email'] ?></td>
                         <td><?php  echo $row['stu_schoolName'] ?></td>
                         <td><?php  echo $row['stu_notes'] ?></td>
                         <td><?php  echo $row['stu_passGrade'] ?></td>
                     ...
                     <tfoot>
                      <tr>
                        ...
                        <div class="pull-right" id="pagination_controls"><?php echo $paginationCtrls; ?> </div> 
			...
			<SCRIPT LANGUAGE="JavaScript">
                                    ...
                                    swal({   title: "Are you sure?",   text: "Do you want to delete these Students ?",   type: "warning",   showCancelButton: true,   confirmButtonColor: "#DD6B55",   confirmButtonText: "Yes, delete them all!",   cancelButtonText: "No, No.. Cancel Please!",   closeOnConfirm: false,   closeOnCancel: false }, function(isConfirm){   if (isConfirm) {  document.myform.action = "actions/deleteoldstu.php?page=OldStudents&PageNo=<?php echo $PNo ?>";  document.myform.submit(); } else {     swal("Cancelled", "It is safe :)", "error");   } });
 ...
 <?php
                       ...
                       $sql_2 = "SELECT * FROM cp_oldstudents WHERE stu_studentID LIKE '%{$SearchKey}%' OR stu_studentname LIKE '%{$SearchKey}%'";
 ...
 <div class="box-body table-responsive no-padding">   
    <table id="vas_table2" class="table table-hover table-bordered table-responsive">
			...
			<SCRIPT LANGUAGE="JavaScript">
                                    ...
                                    swal({   title: "Are you sure?",   text: "Do you want to delete these Students ?",   type: "warning",   showCancelButton: true,   confirmButtonColor: "#DD6B55",   confirmButtonText: "Yes, delete them all!",   cancelButtonText: "No, No.. Cancel Please!",   closeOnConfirm: false,   closeOnCancel: false }, function(isConfirm){   if (isConfirm) {  document.myform2.action = "actions/deleteoldstu.php?page=OldStudents&SearchKey=<?php echo $SearchKey ?>";  document.myform2.submit(); } else {     swal("Cancelled", "It is safe :)", "error");   } });
