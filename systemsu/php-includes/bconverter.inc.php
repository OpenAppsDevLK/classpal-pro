...
?>               
          ...
          <h1>
            ...
            <small>You can change students batch number form here...</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Subjects and Payments</a></li>
            <li><a href="#">View Students</a></li>
            <li class="active">B:Converter</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Batch Number Converter</h3>
           ...
           <!-- general form elements disabled -->
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Batch No Details</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
             ...
             ?>                   
                    ...
                    <div class="form-group">
                      <label>New Batch Number (Ex: Year-Grade-Batch No) OR (Ex: Year-Batch No)</label>
           ...
           <div class="box-footer">
                ...
                <a style="margin-top: 5px;" href="index.php?page=SubNPay&PageNo=1" class="btn  btn-success">View All Subjects </a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Convert Batch Number</h4>
      </div>
      <div class="modal-body">
          Do you really want to convert this batch number... ?
      </div>
