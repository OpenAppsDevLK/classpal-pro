...
include_once '../../php-includes/connect.inc.php'; 
    ...
    $stmt = $db->prepare("SELECT Pay_stu_studentID, pay_student_name, pay_subj_id, pay_subj_Name, pay_paymentdate, pay_paymentmonth, pay_cos_fee, pay_cos_admi, pay_cos_total FROM `cp_payments` WHERE pay_paymentdate BETWEEN '$date01' AND '$date02' ORDER BY pay_paymentdate DESC");
    $stmt->bind_result($Pay_stu_studentID, $pay_student_name, $pay_subj_id, $pay_subj_Name, $pay_paymentdate, $pay_paymentmonth, $pay_cos_fee, $pay_cos_admi, $pay_cos_total);
    $stmt->execute();
          ...
          <div class="col-xs-6">
            <div class="table-responsive">
              ...
              <?php
               ...
               $stmt1 = $db->prepare("SELECT SUM(pay_cos_total) FROM cp_payments WHERE pay_paymentdate BETWEEN '$date01' AND '$date02'");
