  ...
  <body>
    <div class="wrapper">
      ...
      <section class="invoice">
        ...
        <div class="row">
          <div class="col-xs-12">
            <h2 class="page-header">
                <i class="fa fa-users"></i> Report: Students Attendances <br> Subject Name: <?php echo $AS_Sunj_Name; ?> <br> From <?php echo $date01; ?> To <?php echo $date02; ?>
        ...
        $stmt = $db->prepare("SELECT cp_attendance.id,cp_attendance.student_id, cp_attendance.date, cp_attendance.att_time, cp_attendance.lec_name, cp_students.stu_studentID, cp_students.stu_studentname  FROM `cp_attendance` INNER JOIN `cp_students` ON cp_attendance.student_id=cp_students.stu_studentID WHERE cp_attendance.date BETWEEN '$date01' AND '$date02' AND cp_attendance.subj_id = $Subj_ID ORDER BY cp_attendance.date DESC");
        $stmt->bind_result($cp_attendance_id, $cp_attendance_student_id, $cp_attendance_date, $cp_attendance_att_time, $lec_name, $cp_students_stu_studentID, $cp_students_tu_studentname);
        $stmt->execute();
          ...
          <div class="col-xs-6">
            ...
            <div class="table-responsive">
              ...
              <?php
               ...
               $stmt1 = $db->prepare("SELECT COUNT(student_id) FROM cp_attendance WHERE (date BETWEEN '$date01' AND '$date02') AND subj_id = $Subj_ID");
