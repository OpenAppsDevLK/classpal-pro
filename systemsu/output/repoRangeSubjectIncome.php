...
<html>
  <head>
    ...
    <title>Range Subject Incomes</title>
  ...
  <body>
    <div class="wrapper">
      ...
      <section class="invoice">
        ...
        <div class="row">
          <div class="col-xs-12">
            <h2 class="page-header">
                <i class="fa fa-usd"></i> Report: Range Subject Income <br> Subject Name: <?php echo $AS_Sunj_Name; ?> <br> From <?php echo $date01; ?> To <?php echo $date02; ?>
        ...
        $stmt = $db->prepare("SELECT Pay_stu_studentID, pay_student_name, pay_subj_id, pay_paymentdate, pay_paymentmonth, pay_cos_fee, pay_cos_admi, pay_cos_total FROM `cp_payments` WHERE pay_paymentdate BETWEEN '$date01' AND '$date02' AND pay_subj_id = $Subj_ID ORDER BY pay_paymentdate DESC");
