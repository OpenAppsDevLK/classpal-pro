...
?>
        ...
        <div class="row">
          ...
          <div class="col-xs-12 table-responsive">
              ...
              <img  src="<?php echo $stu_image_name; ?>"  class="img-responsive " id="Uploadimg" name="Uploadimg" style=" margin: 0; width:200px;height:200px; border-radius: 10px;">
            ...
            <table id="vas_table" class="table table-hover table-bordered table-responsive">
                    ...
                    <?php
                        ...
                        $stmt = $db->prepare("SELECT stu_ID, stu_studentID, stu_regdate, stu_studentname, stu_address, stu_sex, stu_bday, stu_con_home, stu_con_mobile1, stu_con_mobile2, stu_email, stu_schoolName, stu_notes, stu_passGrade, stu_image_name, stu_accesskey, stu_barcode FROM `cp_students` WHERE stu_studentID = $Student_ID");
                        $stmt->bind_result($stu_ID, $stu_studentID, $stu_regdate, $stu_studentname, $stu_address, $stu_sex, $stu_bday, $stu_con_home, $stu_con_mobile1, $stu_con_mobile2, $stu_email, $stu_schoolName, $stu_notes, $stu_passGrade, $stu_image_name, $stu_accesskey, $stu_barcode);
                        $stmt->execute();
