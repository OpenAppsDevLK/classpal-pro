...
<html>
  <head>
    ...
    <title>All Allocated Students</title>
 ...
 <?php 
               ...
               $stmt4 = $db->prepare("SELECT subj_id, subj_name FROM cp_subjects WHERE subj_id = $Subj_ID");
 ...
 ?>
            <h2 class="page-header">
              <i class="fa fa-users"></i> Report: All Allocated Students | Subject Name: <?php echo $Subj_name; ?>
 ...
 <?php
       ...
       $stmt = $db->prepare("SELECT sa_stu_student_id, sa_stu_student_Name, sa_subj_id, sa_subj_fee, sa_batch_no, sa_notes FROM `cp_subj_allo` WHERE sa_subj_id = $Subj_ID ORDER BY sa_stu_student_id ASC");
          ...
          <div class="col-xs-6">
            <div class="table-responsive">
              ...
              <?php
               ...
               $stmt1 = $db->prepare("SELECT COUNT(sa_stu_student_id) FROM cp_subj_allo WHERE sa_subj_id = $Subj_ID");
