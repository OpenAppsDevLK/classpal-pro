...
<link rel="stylesheet" href="../plugins/sweetalert/sweetalert.css">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="<?php echo $_GET['LecturerID']; ?>" name="abs_lectid" id="act_B_R" placeholder="Enter Actual Bath Rank Hare"  readonly>
  </div> 
 ...
 <?php
  ...
  if (isset($_POST['abs_submit'])) {
    ...
    $stmt = $db->prepare("INSERT INTO `cp_absent` (date, student_id, subj_id, lec_id) VALUES (?, ?, ?, ?)" );
    //i - integer / d - double / s - string / b - BLOB
    $stmt->bind_param('siii', $AB_date, $AB_stuID, $AB_subjID, $AB_lecID);
    $stmt->execute();
    $stmt->close();
